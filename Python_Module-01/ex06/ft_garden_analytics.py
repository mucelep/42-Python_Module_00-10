...
class Plant:
	...
	@staticmethod 	#static metot decoratordür self gibi bir nesne(instance) ye gerek duymaz : nesneyle hiç ilgisi olmayan method
...
class Tree(Plant):
	...
	class stats(Plant.stats):# shade oldugu için cıktıda ekstra böyle bir yöntem yapıyoruz
...
class Seed(Flower):
	def __init__(self, name, height, age, color, num_seeds: int)-> None:
